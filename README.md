...
| [CharacterVault](IronLabs.CharacterVault/) | Both | Saves connected ServerCharacters profiles before a dedicated server stops. |
...
| [ServerGateway](IronLabs.ServerGateway/) | Server-only | Exposes live server information and authenticated local commands. |
